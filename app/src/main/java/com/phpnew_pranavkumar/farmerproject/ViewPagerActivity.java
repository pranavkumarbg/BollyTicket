...
/**
 * Created by kehooo on 11/24/2015.
 */
public class ViewPagerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.xml_row_full_image_view);
    ...
    public ArrayList<Video> getStreamingUrisFromYouTubePage(String ytUrl)
        ...
        ArrayList<Video> videos = new ArrayList<ViewPagerActivity.Video>();
...
//                       + ", type:" + newVideo.type + ", url:" + newVideo.url,"");
    ...
    private class YouTubePageStreamUriGetter extends
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = ProgressDialog.show(ViewPagerActivity.this, "",
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                Log.e("Couldn't get URL","");
            }
            Log.w("Couldn't URI for " + url,"");
            return null;
        }
        ...
        protected void onPostExecute(String streamingUrl) {
            ...
            if (streamingUrl != null) {
                ...
                Toast.makeText(getApplicationContext(),streamingUrl,Toast.LENGTH_LONG).show();
            }
        }
    }
