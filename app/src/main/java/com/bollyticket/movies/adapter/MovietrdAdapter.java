...
public class MovietrdAdapter extends RecyclerView.Adapter<MovietrdAdapter.ViewHolder> {

    private List<MovieData> feedMovieList = new ArrayList<MovieData>();
    private Context mContext;
    OnItemClickListener mItemClickListener;

    public MovietrdAdapter(Context applicationContext, ArrayList<MovieData> feedMovieList) {
